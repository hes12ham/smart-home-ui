...
abstract class SmartyColors {
  static Color primary = const Color(0xff3700b3);
  static Color primary80 = const Color(0xff3700b3).withOpacity(0.8);
  static Color primary60 = const Color(0xff3700b3).withOpacity(0.6);
  static Color primary30 = const Color(0xff3700b3).withOpacity(0.3);
